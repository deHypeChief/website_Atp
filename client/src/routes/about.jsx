...
export default function About() {
  ...
  return <main className="editorialPage aboutV3">
    <PageHero eyebrow="The ATP story" title={<>Built for the<br/>love of tennis.</>} text="An Abuja tennis community where serious coaching, healthy competition and genuine belonging meet." image={about.aboutPageImg || heroImage} actions={<AtpButton to="/membership/adult">Join ATP</AtpButton>}/>
