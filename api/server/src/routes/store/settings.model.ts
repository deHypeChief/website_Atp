...
const storeSettingsSchema = new mongoose.Schema({
  ...
  announcement: { type:String, default:"Complimentary Lagos delivery on orders over ₦75,000", trim:true },
  ...
  deliveryNote: { type:String, default:"Lagos delivery in 1–2 working days. Nationwide delivery in 3–5 working days.", trim:true },
