...
export const COPY_GROUPS: CopyGroup[] = [
    {
        ...
        fields: [
            ...
            { key: "home.membership.cta", label: "Membership button", type: "heading", default: "See membership plans" },
    ...
    },
    {
        ...
        fields: [
            ...
            { key: "membership.special.title", label: "Special plans heading", type: "heading", default: "Special plans" },
            { key: "membership.special.text", label: "Special plans text", type: "text", default: "Built for more than one player — families and couples train on a single plan." },
