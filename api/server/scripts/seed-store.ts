...
const products=[
 ...
 {name:"Court Essentials Bag",slug:"court-essentials-bag",category:"Accessories",collection:"Match Day",description:"A compact carry bag for racquets, grips, balls and the essentials you bring to court.",price:45000,stock:8,colors:[{name:"Ink black",stock:5},{name:"Royale blue",stock:3}],featured:true,images:["/products/accessories.png"],active:true},
];
