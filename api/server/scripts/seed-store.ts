...
const products=[
 ...
 {name:"Club Training Tee",slug:"club-training-tee",category:"Apparel",collection:"Court Code",description:"Breathable ATP training tee made for drills, match play and warm Lagos afternoons.",price:28000,compareAtPrice:34000,stock:18,sizes:["S","M","L","XL"],colors:["Royal blue","Chalk white"],badge:"Player pick",featured:true,images:["/products/apparel.png"],active:true},
